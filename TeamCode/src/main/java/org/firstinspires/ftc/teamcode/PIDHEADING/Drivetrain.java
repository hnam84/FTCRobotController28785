...
public class Drivetrain {
    ...
    public void power(double output){
        // Sử dụng Range.clip để đảm bảo không bị quá tải nhưng vẫn đủ lực
        double out = com.qualcomm.robotcore.util.Range.clip(output, -1.0, 1.0);

        // Đảm bảo dấu của output nhất quán với hướng quay ngược chiều kim đồng hồ (Positive Yaw)
        topLeftDriveMotor.setPower(-out);
        bottomLeftDriveMotor.setPower(-out);
        topRightDriveMotor.setPower(out);
        bottomRightDriveMotor.setPower(out);
    }
